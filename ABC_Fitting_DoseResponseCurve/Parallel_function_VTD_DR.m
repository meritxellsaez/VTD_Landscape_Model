...
% For loop
function Parallel_function_VTD_DR(n)

% Details for batch
struc = Call_Parallel_function_VTD_AbsDist_Modelv5DR_v1(n);
...
if T==0
    load([pathtodata,'/',namedata],'ParticlesMatrixaux')
    PreviousData = ParticlesMatrixaux;
...
%Parallel_function_VTD_DR.m (c) by Elena Camacho Aguilar

%Parallel_function_VTD_DR.m is licensed under a
