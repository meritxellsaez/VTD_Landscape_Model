function simulations = VTD_Landscape_Model_Pred_v5_AbsDistance_Gauss_Fates_EachMut(t0,dt,t1,InitialCondition,nsimulations,paramsimulations,NoiseX,NoiseY,mutantnumber)
...
elseif mutantnumber == 2    %Chir2-2.5
...
elseif mutantnumber == 4    %Chir2-3.5
...
elseif mutantnumber == 7    %Chir2-5_FGF2-3
...
elseif mutantnumber == 8    %Chir2-5_FGF2-3.5
...
elseif mutantnumber == 9    %Chir2-5_FGF2-4
...
elseif mutantnumber == 10    %Chir2-5_FGF2-4.5
...
elseif mutantnumber == 11    %Chir2-5_FGF2-5
...
elseif mutantnumber == 12 %1 Chir Pulse (3h) 
...
elseif mutantnumber == 13 %2 Pulses (3h; 3h)
...
%%Reduced Chir (Dose Response)

elseif mutantnumber == 14 %Reduced CHIR concentration (0.1) from Day 3
    tMediaChanges = [t0;24;t1]; % Times at which there was a media change (time in hours), and the final time
    nMediaChanges = length(tMediaChanges)-1;
...
elseif mutantnumber == 15 %Reduced CHIR concentration (0.3) from Day 3
    tMediaChanges = [t0;24;t1]; % Times at which there was a media change (time in hours), and the final time
    nMediaChanges = length(tMediaChanges)-1;
...
elseif mutantnumber == 16 %Reduced CHIR concentration (0.5) from Day 3
    tMediaChanges = [t0;24;t1]; % Times at which there was a media change (time in hours), and the final time
    nMediaChanges = length(tMediaChanges)-1;
...
%%Predictions No CHIR + PD 
elseif mutantnumber == 17    %CHIR 2-3 PD 3-4
...
elseif mutantnumber == 18    %CHIR 2-3.5 PD 3.5-4.5
...
elseif mutantnumber == 19    %CHIR 2-4 PD 4-5
...
%%Late CHIR
elseif mutantnumber == 20    %CHIR 4-5 
...
%VTD_Landscape_Model_Pred_v5_AbsDistance_Gauss_Fates_EachMut.m (c) by Elena
%Camacho Aguilar and Meritxell Saez Cornellana

%VTD_Landscape_Model_Pred_v5_AbsDistance_Gauss_Fates_EachMut.m is licensed under a
