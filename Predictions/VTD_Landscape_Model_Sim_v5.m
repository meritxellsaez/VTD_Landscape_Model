function [dydt,ChirTime,params]=VTD_Landscape_Model_Sim_v5(t,y,p,dt,ChirTime)


%Chir integration with time.

%% Parameters
params=[zeros(1,6),p(1),p(2),t+dt];
...
params(1:6) = mapped(1:6);


end


%VTD_Landscape_Model_Sim_v5.m (c) by Elena
%Camacho Aguilar and Meritxell Saez Cornellana

%VTD_Landscape_Model_Sim_v5.m is licensed under a
