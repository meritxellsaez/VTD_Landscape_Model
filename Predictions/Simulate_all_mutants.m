...
%Load the parameters accepted in the last round of the Initial fitting algorithm
load('20_11_11_7Mut_SENSITIVITYNEWPRIORS_ABCMv5_10000part_500sim_20par_Eps4_Eps2p97_Eps2p48_Eps2p15_Eps1p95_Eps1p78_Eps1p64_Eps1p56_Eps1p47_Eps1p41_Eps1p33_Eps1p29.mat',...
    'ParticlesMatrixaux');
...
%Number of mutants:
mutantstofit=[1,2,3,4,5,6,7]; %Experimental conditions to simulate as in VTD_Landscape_Model_Pred_v5_AbsDist_Gauss_Fates_EachMut_sim
...
save('Reference_Set_Clusteringv5.mat', 'NewData', 'NewFates', 'MixedGaussian', '-v7.3');

%Simulate_all_mutants.m (c) by Meritxell Saez Cornellana

%Simulate_all_mutants.m is licensed under a
