...
switch Dataset %contains code for the Data
    ...
    case 'DatasetB1'
        ...
        switch DataIdx %contains code for the conditions
            case 1 %No CHIR
                file{2} = fullfile(pathInputfull, 'D2.5_A2_A02_003.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3_A5_A05_006.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5_A10_A10_011.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4_B8_B08_021.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5_C6_C06_031.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5_D4_D04_041.fcs .csv');
            case 2 %CHIR 2-2.5
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 C2-2.5_A8_A08_009.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 C2-2.5_B5_B05_018.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 C2-2.5_C3_C03_028.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 C2-2.5_D1_D01_038.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 C2-2.5_D11_D11_048.fcs .csv');
            case 3 %CHIR 2-3
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 C_A6_A06_007.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 C2-3_A12_A12_013.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 C2-3_B10_B10_023.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 C2-3_C8_C08_033.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 C2-3_D6_D06_043.fcs .csv');
            case 4 %CHIR 2-5
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 C_A6_A06_007.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 C_A11_A11_012.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 C_B9_B09_022.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 C_C7_C07_032.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 C_D5_D05_042.fcs .csv');
            case 5 %CHIR 2-3 0.1
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 C_A6_A06_007.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 C2-3 C0.1_B2_B02_015.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 C2-3 C0.1_B12_B12_025.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 C2-3 C0.1_C10_C10_035.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 C2-3 C0.1_D8_D08_045.fcs .csv');
            case 6 %CHIR 2-3 0.3
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 C_A6_A06_007.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 C2-3 C0.3_B3_B03_016.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 C2-3 C0.3_C1_C01_026.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 C0.3_C11_C11_036.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 C2-3 C0.3_D9_D09_046.fcs .csv');
            case 7 %CHIR 2-3 0.5
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 C_A6_A06_007.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 C2-3 C0.5_B4_B04_017.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 C2-3 C0.5_C2_C02_027.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 C2-3 C0.5_C12_C12_037.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 C2-3 C0.5_D10_D10_047.fcs .csv');
            case 8 %0.1 CHIR 2-5
                file{2} = fullfile(pathInputfull, 'D2.5 C0.1_A4_A04_005.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 C0.1_A7_A07_008.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 C0.1_B1_B01_014.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 C0.1_B11_B11_024.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 C0.1_C9_C09_034.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 C0.1_D7_D07_044.fcs .csv');
            case 9 %CHIR 1 pulse
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 pulse_A9_A09_010.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 1pulse_B6_B06_019.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 1pulse_C4_C04_029.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 1pulse_D2_D02_039.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 1pulse_D12_D12_049.fcs .csv');
            case 10 %CHIR 2 pulses
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 pulse_A9_A09_010.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 2 pulse_B7_B07_020.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 2pulse_C5_C05_030.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 2pulse_D3_D03_040.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 2pulse_E1_E01_050.fcs .csv');
        end
    case 'Dataset B3'
        Days = 6;
        file = cell(1, Days);
        NameDays = {'Day 2.5', 'Day 3', 'Day 3.5', 'Day 4', 'Day 4.5', 'Day 5'};
        ...
        file{1} = fullfile(pathInputfull, 'D2.5_F1_F01_051.fcs .csv');
        file{2} = fullfile(pathInputfull, 'D3_F2_F02_052.fcs .csv');
        file{3} = fullfile(pathInputfull, 'D3.5_F3_F03_053.fcs .csv');
        file{4} = fullfile(pathInputfull, 'D4_F4_F04_054.fcs .csv');
        file{5} = fullfile(pathInputfull, 'D4.5_F5_F05_055.fcs .csv');
        file{6} = fullfile(pathInputfull, 'D5_F6_F06_056.fcs .csv');
    case 'Dataset B2'
        Days = 7;
        file = cell(1, Days);
        NameDays = {'Day 2', 'Day 2.5', 'Day 3', 'Day 3.5', 'Day 4', 'Day 4.5', 'Day 5'};
        ...
        switch DataIdx %contains code for the conditions
            ...
            case 6 %CHIR 2-3 0.3
                ...
                file{4} = fullfile(pathInputfull, 'D3.5 C2-3 C0.3_B3_B03_016.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 C2-3 C0.3_C1_C01_026.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 C2-3 C0.3_C11_C11_036.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 C2-3 C0.3_D9_D09_046.fcs .csv');
            case 7 %CHIR 2-3 0.5
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 C_A6_A06_007.fcs .csv');
            ...
            case 10 %CHIR 2 pulses
                file{2} = fullfile(pathInputfull, 'D2.5 C_A3_A03_004.fcs .csv');
                file{3} = fullfile(pathInputfull, 'D3 pulse_A9_A09_010.fcs .csv');
                file{4} = fullfile(pathInputfull, 'D3.5 2pulse_B7_B07_020.fcs .csv');
                file{5} = fullfile(pathInputfull, 'D4 2pulse_C5_C05_030.fcs .csv');
                file{6} = fullfile(pathInputfull, 'D4.5 2pulse_D3_D03_040.fcs .csv');
                file{7} = fullfile(pathInputfull, 'D5 2pulse_E1_E01_050.fcs .csv');
