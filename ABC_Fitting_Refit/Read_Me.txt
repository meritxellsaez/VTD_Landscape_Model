...
1. Run Parallel_function_VTD_Refit jobmax/njobsperbatch times with input parameter running from 1 to jobmax/njobsperbatch. 
...
3. Update Call_Parallel_function_VTD_AbsDist_Modelv5Refit_v1 
