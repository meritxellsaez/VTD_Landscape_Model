function [dydt,ChirTime]=VTD_Landscape_Model_Fitting_v5Refit(t,y,p,dt,ChirTime)
...
%VTD_Landscape_Model_Fitting_v5Refit.m (c) by Elena
%Camacho Aguilar and Meritxell Saez Cornellana

%VTD_Landscape_Model_Fitting_v5Refit.m is licensed under a
