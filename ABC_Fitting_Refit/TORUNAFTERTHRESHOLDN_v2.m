...
clear
struc = Call_Parallel_function_VTD_AbsDist_Modelv5Refit_v1(1);
...
%Model name:
model = 'VTD_Landscape_Model_Fitting_v5Refit';%Note that the functions called in the fitting use this same root in the file name
...
Samplepopnum1=randsample(10000,100000,true,ParticlesMatrixaux(:,end));
newthreshold = quantile(ParticlesMatrixaux(Samplepopnum1,end-1),0.15);
