function priorvalue=VTD_Landscape_Model_Fitting_v5Refit_EvalPriors(compparamvalue,paramnumber)
...
elseif paramnumber == 9
    %p111
        priorvalue = pdf('Uniform',compparamvalue,0.1,0.9);
elseif paramnumber == 10
    %p112
        priorvalue = pdf('Uniform',compparamvalue,0,0.9);
elseif paramnumber == 11
    %p113
        priorvalue = pdf('Uniform',compparamvalue,-1,0);
elseif paramnumber == 12
    %p114
        priorvalue = pdf('Normal',compparamvalue,-1.35,0.06);
...
elseif paramnumber == 17
    %p103  
        priorvalue = pdf('Normal',compparamvalue,0,0.03); 
elseif paramnumber == 18
    %p104
        priorvalue = pdf('Normal',compparamvalue,-1.4,0.03);
...
elseif paramnumber == 21
    %M
         priorvalue = pdf('Normal',compparamvalue,18,2.5);
elseif paramnumber == 22
    %D
        priorvalue = pdf('Uniform',compparamvalue,1.e-5,1.5e-2);
      
end

%VTD_Landscape_Model_Fitting_v5Refit_EvalPriors.m (c) by Elena
%Camacho Aguilar and Meritxell Saez Cornellana

%VTD_Landscape_Model_Fitting_v5Refit_EvalPriors.m is licensed under a
