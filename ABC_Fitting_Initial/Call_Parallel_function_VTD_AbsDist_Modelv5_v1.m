function struc = Call_Parallel_function_VTD_AbsDist_Modelv5_v1(nbatch)
...
loopept=1;
names = cell(1,1);
names{1} = {''}; %ending of saved files in different iterations
namedata = {'20_11_11_7Mut_SENSITIVITYNEWPRIORS_ABCMv5_10000part_500sim_20par_Eps4'};
pathtodata = '.';%path to the functions and data


%%What follows is fixed for all the fitting procedure
% Mutants to fit:
mutantstofit = [1,2,3,4,5,6,7]; %experimental conditions used in fitting as in VTD_Landscape_Model_Fitting_v5_AbsDist_Gauss_Fates_EachMut
...
% ABC version:
ABCversion = 'ABC_SMC_Algorithm_OLCM_VTD_landscape_v5_Gauss_AbsDistance';
...
%Call_Parallel_function_VTD_AbsDist_Modelv5_v1.m (c) by Elena Camacho Aguilar

%Call_Parallel_function_VTD_AbsDist_Modelv5_v1.m is licensed under a
