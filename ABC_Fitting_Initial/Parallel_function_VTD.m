...
function Parallel_function_VTD(n)

% Details for batch
struc = Call_Parallel_function_VTD_AbsDist_Modelv5_v1(n);
...
%Parallel_function_VTD.m (c) by Elena Camacho Aguilar

%Parallel_function_VTD.m is licensed under a
